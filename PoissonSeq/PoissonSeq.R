...
dat <- list(n=salmon_counts_int, y=y, type=type, pair=pair, gname=gname)
...
plot(log2(res$tt), res$log.fc, col=ifelse(res$fdr < 0.05, "red","gray67"),main="(PoissonSeq) G3 vs. G1 (fdr<0.05, log2FC = ±1)",xlim=c(1,20),pch=20,cex=1,ylim=c(-12,12))
